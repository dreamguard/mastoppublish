...
define("MPU_ADM_HTMLTITULO", "Gestión de páginas HTML");
define("MPU_ADM_FILETITULO", "Gestión de ficheros");
define("MPU_ADM_PGTITULO", "Gestión de contenidos");
define("MPU_ADM_MEDIATITULO", "Gestión de Medios");
define("MPU_ADM_SEARCH", "Buscar");
define("MPU_ADM_UPLOAD", "Cargar página HTML");
define("MPU_ADM_NOVO", "Añadir Contenido");
define("MPU_ADM_EPAGE", "Editar Contenido");
define("MPU_ADM_NMEDIA", "Envíar MEdio");
define("MPU_ADM_EMEDIA", "Editar Medio");
define("MPU_ADM_DMEDIA", "Borrar Medio");
define("MPU_ADM_NFILE", "Envíar Fichero");
define("MPU_ADM_NPG", "Enviíar Fichero de contenido");
define("MPU_ADM_EPG", "Editar Fichero de contenido");
define("MPU_ADM_EFILE", "Editar fichero");
...
define("MPU_ADM_LIMPACONT", "Poner a cero visitas");
define("MPU_ADM_EDITAR", "Editar contenido");
...
define("MPU_ADM_FIL_12_EXIBIR", "¿Mostrar lista de enlaces del editor?");
...
define("MPU_ADM_MPB_12_IMPRIMIR", "¿Mostrar enlaces 'Imprimir'?");
...
define("MPU_ADM_ERR_SELECT_MEDIA", "¡Error! ¡Seleccione un medio!");
define("MPU_ADM_ERR_SELECT_FILE", "¡Error! ¡Seleccione un fichero!");
...
define("MPU_ADM_CONFIRMA_LIMPACONT", "¿ADesea realmente borrar las visitas por página <b># %u</b> - %s?");
define("MPU_ADM_CONFIRMA_DEL_SUB", "¿Desea realmente borrar la página <b># %u</b> - %s?<br><b>¡ATENCION!</b> Esta página contiene %u sub-página(s) que también sera borrada!");
...
define("MPU_ADM_ADMINMAIL", "Correo-E del Admin.");
...
define("MPU_ADM_USERPOSTS", "User Posting");
...
define("MPU_ADM_YEMAIL", "Su correo-E");
...
// V1.1
define("MPU_ADM_USR_10_UID", "Author");
define("MPU_ADM_MPB_EXTERNAL", "External Link");
define("MPU_ADM_MPB_EXTERNAL_URL", "URL to be linked");

define("MPU_ADM_SHOWHIDEMENU", "Show/Hide Menu");
define("MPU_ADM_SHOW_INLINE_MODE", "Ungroup Páginas");
define("MPU_ADM_SHOW_NESTED_MODE", "Group Páginas");
define("MPU_ADM_SHOWSUBS", "Show Sub-Pages");
define("MPU_ADM_SUBS", "Sub-Pages");
