...
$textarea = new XoopsFormTinymce(array('caption'=>'', 'name'=>'mpb_35_conteudo', 'value'=>$mpu_classe->getVar('mpb_35_conteudo', 'n'), 'width'=>'100%', 'height'=>'400px'));
...
$mpb_botao_cancel->setExtra("onclick=\"document.location= '".XOOPS_URL."/modules/".MPU_MOD_DIR."/admin/content.php'\"");
