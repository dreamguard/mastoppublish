 ...
 *
 * @param MastoppublishContent $field  {@link ProfileField} object to get edit form for
 * @param mixed        $action URL to submit to - or false for $_SERVER['REQUEST_URI']
 *
 * @return object
 */
function mastoppublish_getContentForm(MastoppublishContent $field, $action = false)
{
    if ($action === false) {
